...
function renderExtension(renderObj) {
    ...
    if (renderObj && renderObj.projectOverviewUrl) {
        betterDeals = '<div class="visitHere"> <img src="http://s3-ap-southeast-1.amazonaws.com/propguide-prod/wp-content/uploads/2016/09/malls.png" /> Get latest Details <a class="linkToCompare" target="_blank" href="https://www.makaan.com/' + renderObj.projectOverviewUrl + '">click here</a></div>';
    }
